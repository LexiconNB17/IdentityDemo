...
{
    internal class IdentityDemoInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var emails = new[] { "user@lexicon.se", "editor@lexicon.se", "admin@lexicon.se", "root@lexicon.se" };
